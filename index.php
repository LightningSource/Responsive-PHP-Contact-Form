...
const HOST = 'localhost';   #Host's name for connect to database
const USER = 'root';        #Login for connect to database
const PASS = '';            #Password for connect to database
const BASE = 'form_db';     #DataBase's name for connect to database
